...
import com.google.android.webview.databinding.FragmentSettingsBinding
import com.android.webview.common.CommonUtils
import com.android.webview.common.Constants
...
import com.android.webview.util.LangList
import com.android.webview.util.SuUtils
            ...
            findPreference<Preference>("forceCleanEnv")?.setOnPreferenceClickListener {
                MaterialAlertDialogBuilder(requireActivity())
                    ...
                    .setPositiveButton(android.R.string.ok) { _, _ ->
                        val result = SuUtils.execPrivileged("rm -rf /data/misc/hma1-*")
